...
--
-- Name: elements name_id; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements sym_id; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT sym_id UNIQUE (symbol);
